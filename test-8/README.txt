...
# Add Triangle and Empty Triangle Count Histograms as Properties for Pre-Bucketing Potentially Isomorphic Graphs - 13th Nov 2022
                  ...
                  i7-9750H   M2 Pro (9th Apr 2024)  (22nd June) (27th July) (9th August) (16th)
    R(4,4) =? 10     3.7           2.5                   2.7         0.9        0.9        0.9
    R(4,4) =? 11    30.5          24.2                  21.5         7.7        7.3        7.5
    R(4,4) =? 12   194.1         135.5                  89.6        38.5       36.7       37.8
    R(4,4) =? 13   410.9         264.2                 171.7        84.6       81.8       84.7
    R(4,4) == 18   473.9         300.2                 203.7       109.8      106.2      109.4

    R(3,6) =? 11                   1.6                   1.3         0.6        0.6        0.5
    R(3,6) =? 12                  16.2                   8.0         4.5        4.3        4.2
    R(3,6) =? 13                 118.1                  37.0        22.0       21.0       21.1
    R(3,6) =? 14                 280.9                  86.0        56.4       54.1       55.4
    R(3,6) == 18                 329.7                 111.2        76.8       74.6       75.3

    R(4,5) == 10                   52.2                  61.0       18.3       17.4       17.7
    R(4,5) == 11                                                  1644.4

    R(5,5) ==  9                   4.0                    4.5        1.4        1.2        1.2
    R(5,5) == 10                 245.8                  283.0       82.0       77.8       79.8
