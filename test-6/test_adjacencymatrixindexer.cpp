...
TEST(AdjacencyMatrixIndexer, reverse_triangular) {
    ...
    STATIC_ASSERT((I::reverseChecked(2) == make_pair<s64, s64>(2, 1)));
    STATIC_ASSERT((I::reverseChecked(3) == make_pair<s64, s64>(3, 0)));
    STATIC_ASSERT((I::reverseChecked(4) == make_pair<s64, s64>(3, 1)));
